...
describe('ColorWidget', function () {
    it('should render a form with a type color widget', function () {
        var schema = {
            title: 'A schema',
            properties: {
                'color': {
        ...
        (0, _expect2.default)(wrapper.find('input[type=color]').length).toEqual(1);
    });
