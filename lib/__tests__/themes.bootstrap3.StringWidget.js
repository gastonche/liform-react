...
describe('StringWidget', function () {
    it('should render a form with a type text widget', function () {
        var schema = {
            title: 'A schema',
            properties: {
                'field': {
        ...
        (0, _expect2.default)(wrapper.find('input[type=text]').length).toEqual(1);
    });
